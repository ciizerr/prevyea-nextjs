...
import { Library, ArrowRight, Github } from "lucide-react";
                ...
                <div className="w-full max-w-md mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <button className="flex justify-center items-center py-2.5 px-4 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl shadow-sm text-sm font-bold text-zinc-700 dark:text-zinc-300 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors">
                            ...
                            <button className="flex justify-center items-center py-2.5 px-4 bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 border border-transparent rounded-xl shadow-sm text-sm font-bold hover:bg-zinc-800 dark:hover:bg-zinc-100 transition-colors">
                        ...
                        <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                            ...
                            <ClickSpark className="w-full pt-4">
                                <button
                                    type="submit"
                                    className="w-full flex justify-center py-3.5 px-4 border border-transparent rounded-xl shadow-md text-sm font-bold text-white bg-emerald-600 hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 dark:focus:ring-offset-zinc-950 transition-all active:scale-[0.98]"
                                >
                                    Create Account
                                </button>
                            </ClickSpark>
