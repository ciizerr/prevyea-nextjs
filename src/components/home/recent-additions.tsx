            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-end mb-8">
                    ...
                    <ClickSpark className="relative inline-flex">
                        <Link href="#" className="hidden sm:flex items-center text-sm font-semibold text-blue-600 dark:text-blue-400 hover:underline">
                ...
                <div className="bg-white dark:bg-[#0a0a0a] border border-zinc-200 dark:border-zinc-800 rounded-2xl overflow-hidden shadow-sm">
                    {[
                        { title: "BCA Semester 3 - Object Oriented Programming (2024)", type: "PYQ" },
                        { title: "BCA Semester 1 - Math Syllabus Update", type: "Syllabus" },
                        { title: "B.Sc. IT Semester 4 - Database Management Systems", type: "PYQ" },
                        { title: "BBA Semester 2 - Business Economics Notes", type: "Notes" },
                    ].map((item, i) => (
                        <div key={i} className={`flex items-center justify-between p-5 sm:px-6 ${i !== 3 ? 'border-b border-zinc-100 dark:border-zinc-800/60' : ''} hover:bg-zinc-50 dark:hover:bg-zinc-900/50 transition-colors group`}>
                            <div className="flex items-start sm:items-center gap-4">
                                <div className="mt-0.5 sm:mt-0 p-2 bg-zinc-100 dark:bg-zinc-800 rounded-lg text-zinc-500">
                                    <FileText className="h-5 w-5" />
                                </div>
                                <div>
                                    <h4 className="font-semibold text-zinc-900 dark:text-zinc-100 line-clamp-1">{item.title}</h4>
                            ...
                            <ClickSpark className="relative ml-4 shrink-0">
                                <button
                ...
                <ClickSpark className="relative sm:hidden w-full mt-6">
                    <button className="w-full py-3 border border-zinc-200 dark:border-zinc-800 rounded-xl font-medium text-zinc-700 dark:text-zinc-300 cursor-pointer">
                        View all additions
                    </button>
                </ClickSpark>
            </div>
